...
Description: Convert Experiences provides A/B and Multivariate Testing for Experts.
To get started:
1) Click the "Activate" link to the left of this description,
2) <a href="http://www.convert.com/pricing/">Sign up for a free trial</a>
3) Go to your <a href="options-general.php?page=convert-experiences">Convert Experiences configuration page</a>, and enter your project ID.
Author: Convert
