...
class YCE_Admin {
	...
	public function show_warning() {
		echo "<div class='updated'><p><strong>" . __( 'Convert Experiments is almost ready.', 'convert-experiments' ) . "</strong> " . sprintf( __( 'You must <a href="%1$s">enter your Convert Experiences Account and Project IDs</a> for it to work.', 'convert-experiments' ), "options-general.php?page=convert-experiences" ) . "</p></div>";
	}
	...
	public function plugin_action_links( $links, $file ) {
		if ( $file == plugin_basename( dirname( Yoast_Convert_Experiments::PLUGIN_FILE ) . '/convert-experiments.php' ) ) {
			$settings_link = '<a href="options-general.php?page=convert-experiences">' . __( 'Settings', 'convert-experiments' ) . '</a>';
