...
class YCE_Convert_Script {
	...
	public function script() {
		...
		if ( '' != Yoast_Convert_Experiments::get_project_ID() ) {
			...
			$parts = explode( "-", Yoast_Convert_Experiments::get_project_ID() );
			...
			// Ouput default tags
			echo '<script src="https://cdn-4.convertexperiments.com/v1/js/' . $parts[0] . '-' . $parts[1] . '.js" type="text/javascript"></script>' . "\n";
